...
/datum/techweb_node/base
	...
	design_ids = list("basic_matter_bin", "basic_cell", "basic_scanning", "basic_capacitor", "basic_micro_laser", "micro_mani", "basic_electrolite", "c-reader", "desttagger", "salestagger", "handlabel", "packagewrap",
					...
					"plastitanium", "plasmaglass", "plasmareinforcedglass", "titaniumglass", "plastitaniumglass", "plastic_knife", "plastic_fork", "plastic_spoon", "conveyor_belt", "conveyor_switch", "proximity_sensor")
...
/datum/techweb_node/basic_medical
	...
	design_ids = list("cybernetic_liver", "cybernetic_heart", "cybernetic_lungs","cybernetic_stomach", "scalpel",
					...
					"dropper", "defibmountdefault", "surgical_tape", "portable_chem_mixer", "prosthetic_left_leg",
					"prosthetic_right_leg", "prosthetic_left_arm", "prosthetic_right_arm")
